...
- **[Upgrade]** Upgrade UI of Clips (Shorts) - JioHotstar style (Mobile & Web both)
- **[Upgrade]** Upgrade UI of Home banner (Mobile & Web both)
- **[Upgrade]** Upgrade UI of AI-powered recommendation content section (Mobile & Web both)
- **[Upgrade]** Upgrade UI of Details pages (Mobile & Web both)
...
## 🗓 Version 2.0 - 27 Mar 2026
- **[Add]** AI-powered recommendation engine for dynamic content sections
- **[Add]** Wallet and credit system for in-app transactions
- **[Add]** Referral system to enable viral user growth
- **[Upgrade]** Upgraded payment flow for improved reliability and user experience
- **[Improve]** Codebase structure for better scalability and maintainability
- **[Improve]** Application performance and responsiveness
- **[BugFixed]** Minor bugs and stability issues

## 🗓 Version 1.9 - 27 Feb 2026
- **[Add]** Upgraded to Flutter SDK 3.41.0
- **[Add]** Added API Token Authentication
- **[Improve]** Minor bug fixes
- **[Improve]** Code structure improvements
- **[Improve]** Performance optimization

## 🗓 Version 1.8 – 08 Oct 2025
...
- **[BugFixed]** Fix Youtube player issue
- **[BugFixed]** Fix iOS crash issue and updated the app to be compatible with the latest iOS 26.1 release
