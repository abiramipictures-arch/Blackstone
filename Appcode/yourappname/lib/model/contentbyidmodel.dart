...
// final contentByIdModel = contentByIdModelFromJson(jsonString);

import 'dart:convert';

ContentByIdModel contentByIdModelFromJson(String str) =>
    ContentByIdModel.fromJson(json.decode(str));

String contentByIdModelToJson(ContentByIdModel data) =>
    json.encode(data.toJson());

class ContentByIdModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory ContentByIdModel.fromJson(Map<String, dynamic> json) =>
      ContentByIdModel(
        status: json["status"],
