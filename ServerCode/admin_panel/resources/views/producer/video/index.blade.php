    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('producer.video.add', ['type_id' => $type['id']]) }}" class="btn btn-default-white mw-120">
                        <i class="fa-solid fa-plus fa-sm mr-2"></i>{{__('label.add_content')}}
                    </a>
                </div>
            </div>

            <div class="card custom-border-card">
                <div class="card-header"><i class="fa-solid fa-video"></i>{{ $type['name'] }}</div>
                <div class="card-body">
                    ...
                    <div class="page-search p-0 my-2">
                        ...
                        <div class="sorting w-50 mr-2 p-0">
                            <select class="form-control" id="input_premimum">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="release_video" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default mw-120" onclick="release_video()"><i class="fa-solid fa-floppy-disk fa-lg mr-2"></i>{{__('label.update')}}</button>
    ...
    <script>
        ...
        $(document).ready(function () {
            var table = $('#datatable').DataTable({
                ...dataTableDefaults,
                ajax: {
                    url: "{{ route('producer.video.index', ['type_id' => $type['id']]) }}",
                    data: function (d) {
                        d.input_search   = $('#input_search').val();
                        d.input_rent     = $('#input_rent').val();
                        d.input_premimum = $('#input_premimum').val();
            ...
            $('#input_rent, #input_premimum, #input_status').change(function () { table.draw(); });
