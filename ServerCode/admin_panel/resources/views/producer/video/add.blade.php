    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <form id="save_video" enctype="multipart/form-data">
                    ...
                    <div class="card-body py-2">
                        ...
                        <div class="form-row">
                            <div class="col-md-2 pt-3">
                                <div class="form-group">
                                    <label>{{__('label.movies_name')}}</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                ...
                <div class="card custom-border-card mb-3">
                    <div class="card-header"><i class="fa-solid fa-photo-film mr-2"></i><span>{{__('label.description')}} &amp; {{__('label.media')}}</span></div>
                    <div class="card-body py-2">
                        <div class="form-row">
                            <div class="col-8">
                                <div class="form-row">
...
@section('pagescript')
    ...
    <script>
        ...
        function save_video() {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("producer.video.store") }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'save_video', '{{ route("producer.video.index", ["type_id" => $type["id"]]) }}');
                },
