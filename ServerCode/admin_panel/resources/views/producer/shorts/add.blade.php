            ...
            <form id="save_shorts" enctype="multipart/form-data">
                ...
                <div class="card custom-border-card mb-3">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control" rows="5" id="description" placeholder="{{__('label.description_here')}}"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer">
                        <button type="button" class="btn btn-default mw-120" onclick="save_shorts()"><i class="fa-solid fa-floppy-disk fa-lg mr-2"></i>{{__('label.save')}}</button>
...
@section('pagescript')
    ...
    <script>
        function save_shorts() {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("producer.shorts.store") }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'save_shorts', '{{ route("producer.shorts.index", ["type_id" => $type["id"]]) }}');
                },
