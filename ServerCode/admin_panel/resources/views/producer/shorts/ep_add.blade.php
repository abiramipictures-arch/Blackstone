    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('producer.shorts.episode.index', ['id' => $shorts_id, 'type_id' => $type['id']]) }}" class="btn btn-default-white mw-120">{{__('label.episode_list')}}</a>
                </div>
            </div>
            ...
            <form id="save_short_episode" enctype="multipart/form-data">
                ...
                <div class="card custom-border-card mb-3">
                    ...
                    <div class="card-footer">
                        <button type="button" class="btn btn-default mw-120" onclick="save_short_episode()"><i class="fa-solid fa-floppy-disk fa-lg mr-2"></i>{{__('label.save')}}</button>
