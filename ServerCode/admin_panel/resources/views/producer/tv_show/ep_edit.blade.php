        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                <div class="col-sm-10">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('producer.tvshow.episode.index', ['tvshow_id' => $data['show_id'], 'type_id' => $type['id']]) }}">{{__('label.episodes')}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{__('label.edit_episode')}}</li>
                    </ol>
                </div>
                <div class="col-sm-2">
                    <a href="{{ route('producer.tvshow.episode.index', ['tvshow_id' => $data['show_id'], 'type_id' => $type['id']]) }}" class="btn btn-default-white mw-120">{{__('label.episode_list')}}</a>
                </div>
            </div>
            ...
            <form id="save_edit_tvshow_video" enctype="multipart/form-data">
                ...
                <div class="card custom-border-card mb-3">
                    <div class="card-header"><i class="fa-solid fa-film"></i>{{__('label.edit_episode')}}</div>
                ...
                <!-- Video File Card -->
                <div class="card custom-border-card mb-3">
                    <div class="card-header"><i class="fa-solid fa-video"></i>{{__('label.video_file')}}</div>
                    <div class="card-body py-2">
                        <div class="form-row">
                ...
                <!-- Subtitle Card -->
                <div class="card custom-border-card mb-3">
                    <div class="card-header"><i class="fa-solid fa-closed-captioning"></i>{{__('label.subtitle')}}</div>
                    <div class="card-body py-2">
                        <div class="form-row">
                ...
                <!-- Media Card -->
                <div class="card custom-border-card mb-3">
                    <div class="card-header"><i class="fa-solid fa-photo-film"></i>{{__('label.media')}}</div>
                    <div class="card-body py-2">
                        <div class="form-row">
                            <div class="col-6">
                                <div class="form-row">
                    ...
                    <div class="card-footer">
                        <button type="button" class="btn btn-default mw-120" onclick="save_edit_tvshow_video()"><i class="fa-solid fa-floppy-disk fa-lg mr-2"></i>{{__('label.update')}}</button>
                        <a href="{{ route('producer.tvshow.episode.index', ['tvshow_id' => $data['show_id'], 'type_id' => $type['id']]) }}" class="btn btn-cancel mw-120 ml-2">{{__('label.cancel')}}</a>
...
@section('pagescript')
    ...
    <script>
        ...
        function save_edit_tvshow_video() {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("producer.tvshow.episode.update", ["id" => $data->id]) }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'save_edit_tvshow_video', '{{ route("producer.tvshow.episode.index", ["tvshow_id" => $data["show_id"], "type_id" => $type["id"]]) }}');
                },
