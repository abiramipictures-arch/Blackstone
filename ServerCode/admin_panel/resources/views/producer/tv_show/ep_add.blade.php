    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('producer.tvshow.episode.index', ['tvshow_id' => $tvshow_id, 'type_id' => $type['id']]) }}" class="btn btn-default-white mw-120">{{__('label.episode_list')}}</a>
                </div>
            </div>
            ...
            <form id="save_tvshow_video" enctype="multipart/form-data">
                ...
                <div class="card custom-border-card mb-3">
                    <div class="card-header"><i class="fa-solid fa-film"></i>{{__('label.add_episode')}}</div>
                ...
                <div class="card custom-border-card mb-3">
                    ...
                    <div class="card-footer">
                        <button type="button" class="btn btn-default mw-120" onclick="save_tvshow_video()"><i class="fa-solid fa-floppy-disk fa-lg mr-2"></i>{{__('label.save')}}</button>
