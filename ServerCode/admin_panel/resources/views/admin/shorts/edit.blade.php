    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('admin.shorts.index', ['type_id' => $type['id']]) }}" class="btn btn-default-white mw-120">{{__('label.content_list')}}</a>
                </div>
            </div>

            <form id="edit_shorts" enctype="multipart/form-data">
                ...
                <div class="card custom-border-card mb-3">
                    <div class="card-header"><i class="fa-solid fa-film mr-2"></i>{{__('label.name')}}</div>
                ...
                <!-- Basic Detail Card -->
                <div class="card custom-border-card mb-3">
                    <div class="card-header"><i class="fa-solid fa-list-check mr-2"></i>{{__('label.basic_detail')}}</div>
                    <div class="card-body py-2">
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                ...
                <!-- Trailer Card -->
                <div class="card custom-border-card mb-3">
                    <div class="card-header"><i class="fa-solid fa-clapperboard mr-2"></i>{{__('label.trailer')}}</div>
                    <div class="card-body py-2">
                        <div class="form-row">
                ...
                <div class="card custom-border-card mb-3">
                    ...
                    <div class="card-footer">
                        <button type="button" class="btn btn-default mw-120" onclick="edit_shorts()">
...
@section('pagescript')
    ...
    <script>
        function edit_shorts() {
            if ('{{ Demo_Mode() }}' != 1) {
                showError();
                return;
            }

            var formData = new FormData($("#edit_shorts")[0]);
            $("#dvloader").show();
            $.ajax({
                type: 'POST',
                url: '{{ route("admin.shorts.update", [$data->id])}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'edit_shorts', '{{ route("admin.shorts.index", ["type_id" => $type["id"]]) }}');
                },
