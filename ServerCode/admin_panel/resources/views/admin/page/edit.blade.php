	...
	<div class="right-content">
		...
		<div class="body-content">
			...
			<div class="row">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('admin.page.index') }}" class="btn btn-default-white mw-120">{{__('label.page_list')}}</a>
                </div>
            </div>

			<div class="card custom-border-card">
                <div class="card-header"><i class="fa-solid fa-pen-to-square"></i>{{__('label.edit_page')}}</div>
                <form id="page_update" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input name="page_subtitle" type="text" class="form-control" value="{{ $data->page_subtitle }}" placeholder="{{__('label.sub_title_here')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer">
                        <button type="button" class="btn btn-default mw-120" onclick="edit_page()"><i class="fa-solid fa-floppy-disk fa-lg mr-2"></i>{{__('label.update')}}</button>
