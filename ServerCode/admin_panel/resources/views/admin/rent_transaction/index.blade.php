    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('admin.rent-transaction.create') }}" class="btn btn-default-white mw-120">{{__('label.add_transaction')}}</a>
                </div>
            </div>
            ...
            <div class="card custom-border-card">
                <div class="card-header"><i class="fa-solid fa-receipt mr-2"></i>{{__('label.rent_transaction')}}</div>
                <div class="card-body">
