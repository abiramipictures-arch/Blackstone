    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('admin.tvshow.episode.add', ['id' => $tvshow_id, 'type_id' => $type['id']]) }}" class="btn btn-default-white mw-150">
    ...
    <script>
        $(document).ready(function () {
            var table = $('#datatable').DataTable({
                ...dataTableDefaults,
                ajax: {
                    url: "{{ route('admin.tvshow.episode.index', ['id' => $tvshow_id, 'type_id' => $type['id']]) }}",
                    data: function (d) {
        ...
        function change_status(id) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('admin.tvshow.episode.status') }}",
