    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('admin.tvshow.add', ['type_id' => $type['id']]) }}" class="btn btn-default-white mw-120">
            ...
            <div class="card custom-border-card">
                <div class="card-header"><i class="fa-solid fa-tv mr-2"></i>{{ $type['name'] }}</div>
                <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function () {
            var table = $('#datatable').DataTable({
                ...dataTableDefaults,
                ajax: {
                    url: "{{ route('admin.tvshow.index', ['type_id' => $type['id']]) }}",
                    data: function (d) {
            ...
            $('#input_producer, #input_rent, #input_status').change(function () { table.draw(); });
        ...
        function release_tvshow() {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("admin.tvshow.releases") }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function (resp) {
                    ...
                    get_responce_message(resp, 'release_tvshow', '{{ route("admin.tvshow.index", ["type_id" => $type["id"]]) }}');
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    $("#dvloader").hide();
                    toastr.error(errorThrown, textStatus);
