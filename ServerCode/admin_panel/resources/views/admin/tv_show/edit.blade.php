    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('admin.tvshow.index', ['type_id' => $type['id']]) }}" class="btn btn-default-white mw-120">{{__('label.content_list')}}</a>
                </div>
            </div>
            ...
            <form id="edit_TVShow" enctype="multipart/form-data">
                ...
                <div class="card custom-border-card mb-3">
                    <div class="card-header"><i class="fa-solid fa-tv mr-2"></i>{{__('label.tvshow_name')}}</div>
                ...
                <div class="card custom-border-card mb-3">
                    ...
                    <div class="card-footer text-right">
                        <button type="button" class="btn btn-default mw-120" onclick="edit_TVShow()">
